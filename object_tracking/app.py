"""
Trajectory Tracker — Streamlit Web Application
===============================================
...
# Add parent directory so tracker package can be imported
...
if uploaded is not None:
    ...
    if start:
        ...
        while True:
            ...
            img_display.image(combined_rgb, channels="RGB", width='stretch')
